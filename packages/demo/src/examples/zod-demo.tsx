...
export const BasicFormZodExample = () => {
	const userSchema = z
		.object({
...
export const DynamicFormZodExample = () => {
	...
	const updateSkill = (
		index: number,
		field: keyof typeof skillSchema._type,
		value: any
	) => {
			...
			<form onSubmit={form.handleSubmit} className='space-y-6'>
				...
				<div>
					...
					<textarea
						...
						rows={4}
						className={`w-full rounded-md border px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none ${
							form.errors.bio ? 'border-red-500' : 'border-zinc-300'
						}`}
...
export const MultiStepFormZodExample = () => {
	...
	const validateCurrentStep = async () => {
		try {
			...
			await steps[currentStep].schema.parseAsync(currentStepValues);
